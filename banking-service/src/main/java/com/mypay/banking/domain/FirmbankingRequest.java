...
public class FirmbankingRequest {
    ...
    @Getter private final int moneyAmount; // won

    @Getter private final FirmBankingStatus firmbankingStatus; // 0: 요청, 1: 완료, 2: 실패
    ...
    @Value
    public static class FirmStatus {
        public FirmStatus(FirmBankingStatus value) {
